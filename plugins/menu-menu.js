...
let str = `
*ミ❤️ 𝗛𝗢𝗟𝗔 𝗕𝗔𝗕𝗬 ✨${name}✨, 𝗔𝗤𝗨𝗜 𝗘𝗦𝗧𝗔 𝗘𝗟 𝗠𝗘𝗡𝗨 𝗖𝗢𝗠𝗣𝗟𝗘𝗧𝗢 𝗗𝗘 𝗡𝗘𝗞𝗢𝗕𝗢𝗧-𝗠𝗗❤️彡*
...
`.trim()
conn.sendHydrated(m.chat, str, wm, pp, 'https://github.com/Sofiaperez18/NEKOBOT-MD.git', '𝙶𝙸𝚃𝙷𝚄𝙱', null, null, [
['💖 𝘿𝙤𝙣𝙖𝙧 | 𝘿𝙤𝙣𝙖𝙩𝙚', '.donar'],
